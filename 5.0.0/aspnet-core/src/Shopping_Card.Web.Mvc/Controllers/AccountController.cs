...
using Shopping_Card.Web.Models.Account;
using Shopping_Card.Web.Views.Shared.Components.TenantChange;

namespace Shopping_Card.Web.Controllers
{
    public class AccountController : Shopping_CardControllerBase
    {
